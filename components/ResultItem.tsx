  ...
  return (
    <div className="bg-[#161b22] border border-[#30363d] rounded-md p-5">
      <div className="flex items-start justify-between gap-3">
        ...
        <span
          className={[
            "flex-shrink-0 inline-flex items-center justify-center h-6 w-6 rounded-md text-sm font-bold",
            isCorrect
              ? "bg-[#1f2a1f] text-[#2ea043] border border-[#238636]"
      ...
      <ul className="mt-4 space-y-2">
        {keys.map((k) => {
          ...
          if (isCorrectKey) {
            containerClass = "border-[#238636] bg-[#1f2a1f]";
          ...
          return (
            ...
            >
              <span
                className={[
                  "flex-shrink-0 inline-flex items-center justify-center h-6 w-6 rounded-md text-xs font-semibold border",
                  isCorrectKey
              ...
              {isCorrectKey && !isUserPick ? (
                <span className="text-xs text-[#2ea043]">benar</span>
              ) : null}
            </li>
          );
        })}
      ...
      <div className="mt-4 p-3 rounded-md bg-[#0d1117] border border-[#30363d]">
