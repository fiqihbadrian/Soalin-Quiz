      ...
      <main className="flex-1">
        <section className="max-w-4xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
          <div className="text-center">
            <span className="inline-block text-xs uppercase tracking-widest text-[#8b949e] border border-[#30363d] rounded-md px-2 py-1">
            ...
            <div className="mt-10">
              <Link
                href="/upload"
                className="inline-flex items-center justify-center px-6 py-3 rounded-md bg-[#238636] hover:bg-[#2ea043] text-white font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-[#2ea043] focus:ring-offset-2 focus:ring-offset-[#0d1117]"
              >
                Mulai Sekarang
              </Link>
            </div>
